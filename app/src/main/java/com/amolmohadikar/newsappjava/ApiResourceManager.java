...
public class ApiResourceManager {
    ...
    public ApiResourceManager(Context context) {
        this.context = context;
    }

    public void getNewsHeadline(String Country,onFetchDataListener listener , String category , String query )
    {
        ...
        try{
            call.enqueue(new Callback<NewsApiResponse>() {
                ...
                public void onFailure(Call<NewsApiResponse> call, Throwable t) {
                    listener.getError("Resquest failed!!! try again");
